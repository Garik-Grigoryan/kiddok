<template>
  ...
  >
            ...
            <v-slide-y-reverse-transition>
              ...
              >
                <!-- <nuxt-link :to="`/product/${product.id}`"> -->
                  ...
                  <v-btn style="background: #B22180; padding: 12px; text-align: center; border-radius: 16px; color: white; width: 200px; text-transform: none;" @click="openBuyNowModal(product.id)">Գնել հիմա</v-btn>
                <!-- </nuxt-link> -->
              </v-card-text>
            </v-slide-y-reverse-transition>
          </v-card>
    ...
    <div id="buyNowModal" style="display: none;" class="modal-shadow" @click.self="closeModal">
        <div class="modal">
            <slot name="body">
  ...
  export default {
    ...
    methods: {
      ...
      buy() {
        ...
        let product_id = document.querySelector('#buyNowModal .modal').id.replace("product_", "");
