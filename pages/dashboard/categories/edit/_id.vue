...
<script>
    export default {
        ...
        methods: {
          ...
          updateCategory() {
            this.$store.dispatch('categories/updateCategory', [this.$route.params.id, this.name_en, this.name_ru, this.name_am, this.order, this.selectedImages, this.color, this.description, this.parentCategory]).then(r => {
